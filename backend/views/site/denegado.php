<div class="container">
        <div class="error">
            <h1>403</h1>
            <h3 class="denegado">DENEGADO</h2>
            <p class="texto">Lo sentimos, su perfil de usuario no tiene los permisos para acceder a este sitio. Consulte con su administrador.</p>
        </div>
